      ...
      <li className="moviesitem">
        ...
        <div className="moviesitem__right">
          <div className="moviesitem__right-top">
            <h1 className="moviesitem__right-top__tittle">
              {controlTittleOriginalTittle}
            </h1>
            <div
              style={{ borderColor: popularityColor }}
              className="moviesitem__right-top__circle"
            >
              {roundedPopularity}
            </div>
          </div>
          <div className="moviesitem__right-bottom">
            <data className="moviesitem__right-bottom__date">
              ...
              {genres.length !== 0 ? (
                genres.map((genre) => {
                  return (
                    <button
                      key={genre.id}
                      className="moviesitem__right-bottom__janrs"
                    >
                      {genre.name}
                    </button>
                  );
            ...
            <p className="moviesitem__right-bottom__informations">
              {truncatedOverview}
            </p>
